const data = [
    ...
    resources: [
      {
        ...
        description: 'Check the markup of Web documents',
  ...
  },
  {
    ...
    resources: [
      ...
      {
        title: 'CSS Minifier',
        description: 'Online CSS minifier/compressor',
  ...
  },
  {
    ...
    resources: [
      {
        title: 'JavaScript 30',
        description: 'Build 30 things with vanilla JS in 30 days',
    ...
    resources: [
      {
        ...
        description: 'Get hands-on experience making web applications accessible',
    ...
    resources: [
      {
        ...
        description: 'A guide that everyone can use to learn about the practice of front-end development',
      ...
      {
        title: 'HTML & CSS',
        description: 'A nicer way to learn about HTML & CSS',
